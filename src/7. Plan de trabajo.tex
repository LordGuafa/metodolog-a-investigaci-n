...
Una vez entrenados los modelos, se realizará una comparación exhaustiva de su desempeño utilizando métricas de evaluación como exact‑match accuracy, top‑3 accuracy y macro‑F1. Se analizarán los resultados para determinar cuál modelo ofrece el mejor rendimiento en la tarea de detección de acordes.
